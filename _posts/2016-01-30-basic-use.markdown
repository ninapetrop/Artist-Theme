...
Using the terminal navigate to your directory then enter the command: `jekyll s` to start a local server. In your browser enter the local address that Jekyll gives you.
